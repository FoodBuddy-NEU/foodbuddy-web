...
describe('BookmarksPage', () => {
  ...
  it('handles sorting options', () => {
    ...
    const distanceBtn = screen
      .getAllByRole('button')
      .find((btn) => btn.textContent?.includes('Distance'));
    if (distanceBtn) fireEvent.click(distanceBtn);

    // Test sort by price
    const priceBtn = screen
      .getAllByRole('button')
    ...
    const discountBtn = screen
      .getAllByRole('button')
      .find((btn) => btn.textContent?.includes('Discount'));
  ...
  it('toggles sort direction', () => {
    ...
    const ascBtn = screen
      .getAllByRole('button')
      .find((btn) => btn.textContent?.includes('asc') || btn.textContent?.includes('Ascending'));
    if (ascBtn) {
    ...
    const descBtn = screen
      .getAllByRole('button')
      .find((btn) => btn.textContent?.includes('desc') || btn.textContent?.includes('Descending'));
    if (descBtn) {
